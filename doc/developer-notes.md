...
However, in open source software such as Flowercoin Core, where everyone uses
...
pay attention to for reviewers of Flowercoin Core code.

General Flowercoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Flowercoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
