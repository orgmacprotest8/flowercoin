...
Only requiring some minor changes is flowercoin.cpp.
...
Changes to flowercoin.cpp
----------------------
flowercoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
