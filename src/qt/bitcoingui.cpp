    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Flowercoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Flowercoin address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Flowercoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Flowercoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Flowercoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Flowercoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Flowercoin addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Flowercoin Core help message to get a list with possible Flowercoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Flowercoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Flowercoin network", "", count));
}
...
{
    QString strTitle = tr("Flowercoin Core"); // default title
